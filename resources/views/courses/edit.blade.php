<x-app-layout>
    ...
    <div class="py-6 max-w-4xl mx-auto">
        <div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-8 space-y-6">
            ...
            <form action="{{ route('courses.update', $course) }}" method="POST" class="space-y-6" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                ...
                <div>
                    ...
                    <input type="text" name="code" id="code" value="{{ old('code', $course->code) }}" class="w-full rounded-xl border-gray-300 shadow-sm focus:border-indigo-500 focus:ring focus:ring-indigo-200 transition-colors">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                        <label for="cover_image" class="block text-sm font-bold text-gray-700 mb-2">Thumbnail / Cover Image (Opsional)</label>
                    ...
                    <div>
                        ...
                        <p class="text-xs text-gray-500 mt-1">Biarkan kosong jika tidak ingin mengubah. Format: JPG/PNG/WEBP, Maks 2MB. Resolusi disarankan 1920x400.</p>
                ...
                <div class="pt-4">
                    <label class="relative flex items-center cursor-pointer">
                        <input type="checkbox" name="is_leaderboard_enabled" value="1" class="sr-only peer" {{ $course->is_leaderboard_enabled ? 'checked' : '' }}>
